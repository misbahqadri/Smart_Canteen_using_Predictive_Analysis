...
from .models import Product, Contact, Orders, OrderUpdate, Can
...
admin.site.site_header = "Smart Canteen"
admin.site.index_title = "Smart Canteen p"
admin.site.site_title = "Smart Canteen pred"
